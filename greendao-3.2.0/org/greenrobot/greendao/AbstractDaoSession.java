...
/**
 * DaoSession gives you access to your DAOs, offers convenient persistence 持续 methods, and also serves as a session cache.<br>
 * <br>
 ...
 * avoid the overhead imposed 强加的 by DaoSession (the overhead is small, but it may add up).<br>
 * <br>
...
public class AbstractDaoSession {
    ...
    /** Allows to inspect 检查 检验 the meta model using DAOs (e.g. querying table names or properties). */
