 ...
 * {@link ViewGroup#getChildAt}. Contrast 对比 with <em>Position.</em></li>
 ...
 * later. This can drastically 大大的 improve performance by skipping initial layout inflation
 * or construction.</li>
 * <li><em>Scrap 碎片(view):</em> A child view that has entered into a temporarily detached
 ...
 * last layout calculation. You can rely on these positions to be consistent 始终如一的 with what user is
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    /**
     * On Kitkat 4.4 API19 and JB MR2, there is a bug which prevents DisplayList from being invalidated if
     ...
     * that the RecyclerView should use the standard touch slop 溢出 for smooth 流畅地 ,
     * continuous 连续的 scrolling.
     */
     ...
     * widgets that snap 突然的 to a page or other coarse-grained 粗糙的-有木纹的 barrier 障碍物 界线 .
     */
     ...
     * If there are too many of these in Systrace 系统调用跟踪提供器 , some Views inside RecyclerView might
     * be causing it. Try to avoid using EditText, focusable views or handle them with care.
     */
     ...
     * If this is taking a long time, try sending granular 颗粒的 notify adapter changes instead of just
    ...
    // This value is used when handling generic motion 手势 events.
