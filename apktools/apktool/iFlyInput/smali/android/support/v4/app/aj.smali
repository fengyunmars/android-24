...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    iput-object p4, p0, Landroid/support/v4/app/aj;->d:Landroid/transition/Transition;

    iput-object p5, p0, Landroid/support/v4/app/aj;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Landroid/support/v4/app/aj;->f:Landroid/transition/Transition;

    iput-object p7, p0, Landroid/support/v4/app/aj;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Landroid/support/v4/app/aj;->h:Ljava/util/Map;

    iput-object p9, p0, Landroid/support/v4/app/aj;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Landroid/support/v4/app/aj;->j:Landroid/transition/Transition;

    iput-object p11, p0, Landroid/support/v4/app/aj;->k:Landroid/view/View;
...
.method public final onPreDraw()Z
    ...
    .line 359
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/aj;->d:Landroid/transition/Transition;
    ...
    .line 362
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/aj;->f:Landroid/transition/Transition;
    ...
    .line 365
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/aj;->h:Ljava/util/Map;
    ...
    .line 372
    iget-object v4, p0, Landroid/support/v4/app/aj;->j:Landroid/transition/Transition;
    ...
    .line 374
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/aj;->j:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/aj;->k:Landroid/view/View;
