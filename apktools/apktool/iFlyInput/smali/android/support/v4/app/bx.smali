...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/bx;->a:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/app/bx;->d:Ljava/lang/Object;

    return-void
.end method

.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/app/bt;)Landroid/os/Bundle;
    .locals 3

    .prologue
    .line 258
    invoke-virtual {p1}, Landroid/support/v4/app/bt;->a()I

    move-result v0

    invoke-virtual {p1}, Landroid/support/v4/app/bt;->b()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p1}, Landroid/support/v4/app/bt;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/bt;->d()Landroid/os/Bundle;
    ...
    .line 260
    invoke-virtual {p1}, Landroid/support/v4/app/bt;->e()[Landroid/support/v4/app/cu;
    ...
    invoke-static {v2}, Landroid/support/v4/app/cw;->a([Landroid/support/v4/app/cu;)[Landroid/os/Bundle;
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 212
    sget-object v2, Landroid/support/v4/app/bx;->a:Ljava/lang/Object;

    monitor-enter v2

    .line 213
    :try_start_0
    sget-boolean v0, Landroid/support/v4/app/bx;->c:Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/app/bx;->b:Ljava/lang/reflect/Field;
    ...
    sput-boolean v0, Landroid/support/v4/app/bx;->c:Z
    :try_end_1
    ...
    .line 225
    sput-object v0, Landroid/support/v4/app/bx;->b:Ljava/lang/reflect/Field;
    ...
    .line 230
    sget-object v3, Landroid/support/v4/app/bx;->b:Ljava/lang/reflect/Field;
