...
.method public constructor <init>(La/a;La/a/b/d;)V
    ...
    invoke-direct {p0, v0, v1}, La/a/b/f;->a(La/r;Ljava/net/Proxy;)V
...
.method private a(La/r;Ljava/net/Proxy;)V
    .locals 3
    ...
    invoke-virtual {p1}, La/r;->a()Ljava/net/URI;
...
.method private a(Ljava/net/Proxy;)V
    ...
    invoke-static {v0}, La/a/b/f;->a(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, La/a;->b()La/o;

    move-result-object v1

    invoke-interface {v1, v0}, La/o;->a(Ljava/lang/String;)Ljava/util/List;
...
# virtual methods
.method public a(La/ab;Ljava/io/IOException;)V
    .locals 3

    invoke-virtual {p1}, La/ab;->b()Ljava/net/Proxy;
    ...
    invoke-virtual {v1}, La/r;->a()Ljava/net/URI;
    ...
    invoke-virtual {v0, p1}, La/a/b/d;->a(La/ab;)V
...
.method public b()La/ab;
    ...
    :cond_0
    invoke-direct {p0}, La/a/b/f;->h()La/ab;
    ...
    :cond_2
    invoke-direct {p0}, La/a/b/f;->d()Ljava/net/Proxy;
    ...
    :cond_3
    invoke-direct {p0}, La/a/b/f;->f()Ljava/net/InetSocketAddress;
    ...
    invoke-direct {v0, v1, v2, v3}, La/ab;-><init>(La/a;Ljava/net/Proxy;Ljava/net/InetSocketAddress;)V

    iget-object v1, p0, La/a/b/f;->b:La/a/b/d;

    invoke-virtual {v1, v0}, La/a/b/d;->c(La/ab;)Z
    ...
    invoke-virtual {p0}, La/a/b/f;->b()La/ab;
