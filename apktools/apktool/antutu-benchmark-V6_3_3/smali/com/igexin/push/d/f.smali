...
.method public a(Z)J
    ...
    const-string v3, "NormalModel|resetDelay = "
    ...
    const-string v2, "NormalModel|isResetDelay = true, reconnect delayTime = 0"
    ...
    const-string v5, "NormalModel|isSdkOn = "
    ...
    const-string v5, " isPushOn = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget-boolean v5, Lcom/igexin/push/core/g;->k:Z

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " checkIsSilentTime = "
    ...
    const-string v5, " isBlockEndTime = "
    ...
    sget-boolean v4, Lcom/igexin/push/core/g;->k:Z
    ...
    :cond_1
    const-string v2, "NormalModel|reconnect stop, interval= 1h ++++"
    ...
    :cond_2
    sget-wide v2, Lcom/igexin/push/core/g;->E:J
