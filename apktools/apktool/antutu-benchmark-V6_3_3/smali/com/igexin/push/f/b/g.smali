...
.method public static declared-synchronized g()Lcom/igexin/push/f/b/g;
    .locals 2
...
.method protected a()V
    ...
    const-string v3, "ReconnectTimerTask|networkAvailable = "
    ...
    :cond_0
    const-string v0, "ReconnectTimerTask reconnect timer task stop, connect interval= 1h #######"
    ...
    :cond_1
    const-string v0, "ReconnectTimerTask reconnect timer task isOnline = false, try login..."
...
.method public h()V
    ...
    const-string v3, "ReconnectTimerTask|refreshDelayTime, delay = "
    ...
    const-string v2, "ReconnectTimerTask|refreshDelayTime, already enter backup or trynormal #####"
    ...
    :cond_1
    const-string v0, "ReconnectTimerTask|detect ip = null and not enter backup,  wait for detect, delay = 3600000"
