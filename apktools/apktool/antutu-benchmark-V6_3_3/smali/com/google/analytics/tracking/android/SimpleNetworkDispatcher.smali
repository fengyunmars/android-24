...
.method public dispatchHits(Ljava/util/List;)I
    ...
    iget-object v0, p0, Lcom/google/analytics/tracking/android/SimpleNetworkDispatcher;->httpClientFactory:Lcom/google/analytics/tracking/android/HttpClientFactory;

    invoke-interface {v0}, Lcom/google/analytics/tracking/android/HttpClientFactory;->newInstance()Lorg/apache/http/client/HttpClient;
    ...
    invoke-direct {p0, v0}, Lcom/google/analytics/tracking/android/SimpleNetworkDispatcher;->getUrl(Lcom/google/analytics/tracking/android/Hit;)Ljava/net/URL;
    ...
    :goto_3
    invoke-direct {p0, v0, v5}, Lcom/google/analytics/tracking/android/SimpleNetworkDispatcher;->buildRequest(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-direct {p0, v7, v5}, Lcom/google/analytics/tracking/android/SimpleNetworkDispatcher;->logDebugInformation(ZLorg/apache/http/HttpEntityEnclosingRequest;)V
