...
.method protected a(Ljava/lang/String;ZILjava/lang/String;)V
    .locals 13
    ...
    :cond_1
    invoke-static {p1}, Lanet/channel/strategy/n;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "errorDetail"

    const-string v7, "connect_avail"

    const-string v8, "host"

    const-string v9, "type_inapp"

    const-string v10, "is_center_host"
    ...
    invoke-virtual {v12, v1, v2}, Landroid/content/Intent;->setClassName(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v2, v3}, Lanet/channel/strategy/n;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v12, v8, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    invoke-virtual {v11}, Ljava/net/URL;->getHost()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lanet/channel/strategy/n;->a(Ljava/lang/String;)Z

    move-result v2

    invoke-virtual {v12, v10, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    :cond_2
    invoke-virtual {v12, v7, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const/4 v2, 0x1

    invoke-virtual {v12, v9, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    const-string v3, "sendConnectInfoBroadCastToAccs"
