...
.method public static a(Lanet/channel/request/Request;Lanet/channel/RequestCb;)Lanet/channel/session/c$a;
    ...
    invoke-direct {v4, v2, v2}, Lanet/channel/statist/RequestStatistic;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p1, v0, v1, v4}, Lanet/channel/RequestCb;->onFinish(ILjava/lang/String;Lanet/channel/statist/RequestStatistic;)V
    ...
    invoke-static {p0, v3, p1, v0, v2}, Lanet/channel/session/c;->a(Lanet/channel/request/Request;Lanet/channel/session/c$a;Lanet/channel/RequestCb;ILjava/lang/Throwable;)V
    ...
    invoke-static {v1, p0}, Lanet/channel/session/c;->b(Ljava/net/HttpURLConnection;Lanet/channel/request/Request;)V

    invoke-virtual {v1}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v0

    iput v0, v3, Lanet/channel/session/c$a;->a:I

    invoke-virtual {v1}, Ljava/net/HttpURLConnection;->getHeaderFields()Ljava/util/Map;

    move-result-object v0

    invoke-static {v0}, Lanet/channel/util/d;->a(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v0

    iput-object v0, v3, Lanet/channel/session/c$a;->c:Ljava/util/Map;
    ...
    iget v0, v3, Lanet/channel/session/c$a;->a:I

    iget-object v4, v3, Lanet/channel/session/c$a;->c:Ljava/util/Map;

    invoke-static {p0, v0, v4}, Lanet/channel/util/d;->a(Lanet/channel/request/Request;ILjava/util/Map;)Z
    :try_end_0
    ...
    invoke-static {v4, v5, v2, v0, v6}, Lanet/channel/util/ALog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    ...
    invoke-interface {p1, v0, v4}, Lanet/channel/RequestCb;->onResponseCode(ILjava/util/Map;)V
    ...
    iput-wide v4, v0, Lanet/channel/statist/RequestStatistic;->oneWayTime:J

    iget-object v0, p0, Lanet/channel/request/Request;->rs:Lanet/channel/statist/RequestStatistic;

    const/4 v4, 0x1

    iput-boolean v4, v0, Lanet/channel/statist/RequestStatistic;->ret:Z
    ...
    invoke-interface {p1, v0, v4, v5}, Lanet/channel/RequestCb;->onFinish(ILjava/lang/String;Lanet/channel/statist/RequestStatistic;)V
    :try_end_2
    ...
    invoke-static {v1, v4, v2, v0, v5}, Lanet/channel/util/ALog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V

    goto/16 :goto_1

    :cond_9
    :try_start_4
    iget-object v0, v3, Lanet/channel/session/c$a;->c:Ljava/util/Map;

    invoke-static {v0}, Lanet/channel/util/d;->b(Ljava/util/Map;)Z
    ...
    :cond_a
    invoke-static {v1, p0, v3, p1}, Lanet/channel/session/c;->a(Ljava/net/HttpURLConnection;Lanet/channel/request/Request;Lanet/channel/session/c$a;Lanet/channel/RequestCb;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static {p0, v3, p1, v4, v0}, Lanet/channel/session/c;->a(Lanet/channel/request/Request;Lanet/channel/session/c$a;Lanet/channel/RequestCb;ILjava/lang/Throwable;)V
