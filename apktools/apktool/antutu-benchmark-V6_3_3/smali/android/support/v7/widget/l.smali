...
.method private a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->a:[I

    aput-object v5, v2, v4

    sget v5, Landroid/support/v7/appcompat/R$attr;->colorControlNormal:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/bc;->c(Landroid/content/Context;I)I
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->b:[I
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->c:[I
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->d:[I
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->e:[I
    ...
    sget-object v5, Landroid/support/v7/widget/bc;->f:[I
    ...
    sget-object v4, Landroid/support/v7/widget/bc;->h:[I
...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V
    .locals 2
    ...
    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/bf;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, p1, Landroid/support/v7/widget/bf;->b:Landroid/graphics/PorterDuff$Mode;
...
.method private b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/bc;->c(Landroid/content/Context;I)I
...
.method private c(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v5, v3}, Landroid/support/v7/widget/bc;->a(Landroid/content/Context;IF)I
    ...
    invoke-static {p1, v3, v4}, Landroid/support/v7/widget/bc;->a(Landroid/content/Context;IF)I
    ...
    invoke-static {p1, v5, v4}, Landroid/support/v7/widget/bc;->a(Landroid/content/Context;IF)I
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bc;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    sget-object v2, Landroid/support/v7/widget/bc;->a:[I
    ...
    sget-object v2, Landroid/support/v7/widget/bc;->e:[I
...
.method private e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object v3, Landroid/support/v7/widget/bc;->g:[I
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v4}, Landroid/support/v7/widget/bc;->c(Landroid/content/Context;I)I
    ...
    sget-object v4, Landroid/support/v7/widget/bc;->d:[I
    ...
    sget-object v4, Landroid/support/v7/widget/bc;->b:[I
...
.method public final a(Landroid/content/Context;Landroid/support/v7/widget/bj;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-virtual {p2, p3}, Landroid/support/v7/widget/bj;->a(I)Landroid/graphics/drawable/Drawable;
