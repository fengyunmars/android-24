...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bf;
    .locals 3
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->f:Landroid/support/v7/widget/bf;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/bf;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bf;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bf;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->f:Landroid/support/v7/widget/bf;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/bf;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/l;I)Landroid/support/v7/widget/bf;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bf;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bf;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/y;->f:Landroid/support/v7/widget/bf;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/bf;
