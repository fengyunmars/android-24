...
.method private invalidApiInvocation()V
    ...
    const-string/jumbo v1, "MqttClient API called in a callback method! Use a different thread."
...
.method private loadLocalBindings()Ljava/lang/Class;
    ...
    :try_start_0
    const-string/jumbo v2, "com.ibm.mqtt.local.MqttLocalBindingV2"
    ...
    :try_start_1
    const-string/jumbo v0, "com.ibm.mqtt.local.MqttLocalBindingV1"
    ...
    const-string/jumbo v2, "LocalBinding unavailable: Microbroker classes not found"
...
.method private loadTcpBindings()Ljava/lang/Class;
    ...
    :try_start_0
    const-string/jumbo v2, "com.ibm.mqtt.j2se.MqttJavaNetSocket"
    ...
    :try_start_1
    const-string/jumbo v0, "com.ibm.mqtt.midp.MqttMidpSocket"
    ...
    const-string/jumbo v2, "Cannot locate a J2SE Socket or J2ME StreamConnection class"
...
.method public connect(Ljava/lang/String;ZSLjava/lang/String;ILjava/lang/String;Z)V
    ...
    const-string/jumbo v2, " not received"
    ...
    const-string/jumbo v3, "WMQTT protocol name or version not supported:"
    ...
    const-string/jumbo v1, "WMQTT ClientId is invalid"
    ...
    const-string/jumbo v1, "WMQTT Broker is unavailable"
...
.method protected connectionLost()V
    ...
    const-string/jumbo v1, "WMQtt Connection Lost"
...
.method protected initialise(Ljava/lang/String;Lcom/ibm/mqtt/MqttPersistence;)V
    ...
    :try_start_0
    const-string/jumbo v1, "com.ibm.mqtt.trace.MQeTraceToBinaryFile"
    ...
    const-string/jumbo v2, "Unrecognised connection method:"
...
.method public publish(Ljava/lang/String;[BIZ)I
    ...
    const-string/jumbo v1, "NULL topic"
    ...
    const-string/jumbo v1, "Topic contains \'#\' or \'+\'"
...
.method public startTrace()V
    ...
    const-string/jumbo v1, "Trace classes (com.ibm.mqtt.trace.*) not found.\nCheck they are in wmqtt.jar."
...
.method public subscribe([Ljava/lang/String;[I)I
    ...
    const-string/jumbo v1, "NULL topic array"
    ...
    const-string/jumbo v1, "NULL requested QoS array"
    ...
    const-string/jumbo v2, "Array lengths unequal. Topics:"
    ...
    const-string/jumbo v3, "NULL topic in topic array at index "
