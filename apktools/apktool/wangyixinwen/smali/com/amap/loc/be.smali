...
# static fields
.field private static a:Lcom/amap/loc/be;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/loc/be;->a:Lcom/amap/loc/be;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amap/loc/be;->b:Ljava/util/Hashtable;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/amap/loc/be;->c:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/amap/loc/be;->d:Z

    return-void
.end method

.method private declared-synchronized a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/loc/be$a;
    .locals 18
    ...
    iget-object v2, v0, Lcom/amap/loc/be;->b:Ljava/util/Hashtable;
    ...
    check-cast v0, Lcom/amap/loc/be$a;

    move-object v4, v0

    invoke-virtual {v4}, Lcom/amap/loc/be$a;->b()Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v1}, Lcom/amap/loc/be;->b(Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v0, v6, v1}, Lcom/amap/loc/be;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-direct {v0, v3, v11}, Lcom/amap/loc/be;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v3, v12}, Lcom/amap/loc/be;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v15, v1}, Lcom/amap/loc/be;->a([D[D)[D
...
.method public static declared-synchronized a()Lcom/amap/loc/be;
    .locals 2

    const-class v1, Lcom/amap/loc/be;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/amap/loc/be;->a:Lcom/amap/loc/be;

    if-nez v0, :cond_0

    new-instance v0, Lcom/amap/loc/be;

    invoke-direct {v0}, Lcom/amap/loc/be;-><init>()V
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    invoke-static {}, Lcom/amap/loc/bo;->r()Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0}, Lcom/amap/loc/be;->b()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0}, Lcom/amap/loc/be;->c()V
    ...
    :cond_3
    iget-object v0, p0, Lcom/amap/loc/be;->b:Ljava/util/Hashtable;
    ...
    invoke-direct {p0, p2, p1}, Lcom/amap/loc/be;->a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/loc/be$a;
    ...
    invoke-virtual {v0}, Lcom/amap/loc/be$a;->a()Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    sget-object v2, Lcom/amap/loc/bd;->d:Ljava/lang/String;
    ...
    sput-object v2, Lcom/amap/loc/bd;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/amap/loc/bo;->b(J)Z
...
.method public a(Landroid/content/Context;)V
    ...
    iget-boolean v0, p0, Lcom/amap/loc/be;->d:Z
    ...
    invoke-virtual {v0, p1}, Lcom/amap/loc/bg;->a(Landroid/content/Context;)V
    :try_end_0
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;Landroid/content/Context;Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p3}, Lcom/amap/loc/be;->a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v2}, Lcom/amap/loc/bv;->a(Lorg/json/JSONObject;Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lcom/amap/loc/bv;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/amap/loc/be;->a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    new-instance v1, Lcom/amap/loc/be$a;

    invoke-direct {v1}, Lcom/amap/loc/be$a;-><init>()V

    invoke-virtual {v1, p3}, Lcom/amap/loc/be$a;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)V
    ...
    :goto_2
    invoke-virtual {v1, v0}, Lcom/amap/loc/be$a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p3, p2, p4}, Lcom/amap/loc/bg;->a(Ljava/lang/String;Lcom/amap/api/location/AMapLocation;Ljava/lang/StringBuilder;Landroid/content/Context;)V
    :try_end_2
    ...
    iget-object v1, p0, Lcom/amap/loc/be;->b:Ljava/util/Hashtable;
...
.method public a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-static {p2}, Lcom/amap/loc/bv;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
...
.method public b()Z
    ...
    iget-wide v4, p0, Lcom/amap/loc/be;->c:J
    ...
    :cond_1
    iget-object v4, p0, Lcom/amap/loc/be;->b:Ljava/util/Hashtable;
