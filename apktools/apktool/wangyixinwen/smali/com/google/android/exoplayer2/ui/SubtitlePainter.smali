...
.method public draw(Lcom/google/android/exoplayer2/text/Cue;ZLcom/google/android/exoplayer2/text/CaptionStyleCompat;FFLandroid/graphics/Canvas;IIII)V
    ...
    iget v2, v0, Lcom/google/android/exoplayer2/text/Cue;->windowColor:I
    ...
    iget-object v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueText:Ljava/lang/CharSequence;

    invoke-static {v4, v3}, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->areCharSequencesEqual(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    iget-object v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueTextAlignment:Landroid/text/Layout$Alignment;

    move-object/from16 v0, p1

    iget-object v5, v0, Lcom/google/android/exoplayer2/text/Cue;->textAlignment:Landroid/text/Layout$Alignment;
    ...
    iget v5, v0, Lcom/google/android/exoplayer2/text/Cue;->lineType:I
    ...
    iget v5, v0, Lcom/google/android/exoplayer2/text/Cue;->size:F
    ...
    iget-boolean v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->applyEmbeddedStyles:Z
    ...
    iget v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->foregroundColor:I

    move-object/from16 v0, p3

    iget v5, v0, Lcom/google/android/exoplayer2/text/CaptionStyleCompat;->foregroundColor:I
    ...
    iget v5, v0, Lcom/google/android/exoplayer2/text/CaptionStyleCompat;->backgroundColor:I

    if-ne v4, v5, :cond_3

    move-object/from16 v0, p0

    iget v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->windowColor:I

    if-ne v4, v2, :cond_3

    move-object/from16 v0, p0

    iget v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->edgeType:I

    move-object/from16 v0, p3

    iget v5, v0, Lcom/google/android/exoplayer2/text/CaptionStyleCompat;->edgeType:I

    if-ne v4, v5, :cond_3

    move-object/from16 v0, p0

    iget v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->edgeColor:I

    move-object/from16 v0, p3

    iget v5, v0, Lcom/google/android/exoplayer2/text/CaptionStyleCompat;->edgeColor:I
    ...
    iget-object v5, v0, Lcom/google/android/exoplayer2/text/CaptionStyleCompat;->typeface:Landroid/graphics/Typeface;
    ...
    iput-object v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueTextAlignment:Landroid/text/Layout$Alignment;
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueLine:F
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueLineType:I
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueLineAnchor:I
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cuePosition:F
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cuePositionAnchor:I
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->cueSize:F
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->foregroundColor:I
    ...
    iput v4, v0, Lcom/google/android/exoplayer2/ui/SubtitlePainter;->backgroundColor:I
