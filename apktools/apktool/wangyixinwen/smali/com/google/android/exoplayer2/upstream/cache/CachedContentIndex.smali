...
.method private readFile()Z
    ...
    iput-boolean v3, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContentIndex;->changed:Z
    :try_end_8
    ...
    :goto_5
    :try_start_9
    const-string/jumbo v3, "CachedContentIndex"

    const-string/jumbo v4, "Error reading cache content index file."
...
.method private writeFile()V
    ...
    invoke-direct {v4, v2}, Lcom/google/android/exoplayer2/util/ReusableBufferedOutputStream;-><init>(Ljava/io/OutputStream;)V
    ...
    .line 291
    iget-object v4, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContentIndex;->cipher:Ljavax/crypto/Cipher;
    ...
    .line 311
    invoke-virtual {v0, v2}, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->writeToStream(Ljava/io/DataOutputStream;)V
    ...
    invoke-virtual {v4, v2}, Lcom/google/android/exoplayer2/util/ReusableBufferedOutputStream;->reset(Ljava/io/OutputStream;)V
    :try_end_5
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/exoplayer2/util/AtomicFile;->endWrite(Ljava/io/OutputStream;)V
    :try_end_8
...
.method public removeEmpty()V
    ...
    .line 186
    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/upstream/cache/CachedContentIndex;->removeEmpty(Ljava/lang/String;)V
