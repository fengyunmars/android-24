...
.method static synthetic a(Lcom/igexin/sdk/PushManager;J)J
    .locals 1

    iput-wide p1, p0, Lcom/igexin/sdk/PushManager;->h:J
...
.method static synthetic a(Lcom/igexin/sdk/PushManager;Landroid/content/Context;Ljava/lang/Class;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/igexin/sdk/PushManager;->a(Landroid/content/Context;Ljava/lang/Class;)V
...
.method private registerPushActivity(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    const-string/jumbo v3, "can\'t load activity = "
    ...
    const-string/jumbo v1, "call -> registerPushActiviy, parameter [activity] is null"
...
.method public bindAlias(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "call - > bindAlias failed, it be called too frequently"
...
.method public initialize(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iget-wide v2, p0, Lcom/igexin/sdk/PushManager;->h:J
    ...
    new-instance v1, Lcom/igexin/sdk/c;

    invoke-direct {v1, p0, p1, p2}, Lcom/igexin/sdk/c;-><init>(Lcom/igexin/sdk/PushManager;Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iput-wide v0, p0, Lcom/igexin/sdk/PushManager;->h:J
...
.method public registerPushIntentService(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    const-string/jumbo v2, "call - > registerPushIntentService, parameter [userIntentService] is set, but didn\'t find class \""
    ...
    const-string/jumbo v3, "can\'t load IntentService = "
    ...
    const-string/jumbo v1, "call -> registerPushIntentService, parameter [userIntentService] is null, use default Receiver"
...
.method public sendFeedbackMessage(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v1, "call - > sendFeedbackMessage failed, parameter is illegal"
...
.method public sendMessage(Landroid/content/Context;Ljava/lang/String;[B)Z
    ...
    const-string/jumbo v1, "call - > sendMessage failed, parameter is illegal or it be called too frequently"
...
.method public setHeartbeatInterval(Landroid/content/Context;I)Z
    ...
    const-string/jumbo v1, "call -> setHeartbeatInterval failed, parameter [interval] < 0, illegal"
...
.method public setSilentTime(Landroid/content/Context;II)Z
    ...
    const-string/jumbo v1, "call - > setSilentTime failed, parameter [beginHour] or [duration] value exceeding"
...
.method public setSocketTimeout(Landroid/content/Context;I)Z
    ...
    const-string/jumbo v1, "call - > setSocketTimeout failed, parameter [timeout] < 0, illegal"
...
.method public setTag(Landroid/content/Context;[Lcom/igexin/sdk/Tag;Ljava/lang/String;)I
    ...
    const-string/jumbo v2, "call -> setTag failed, parameter [tags] is null"
    ...
    const-string/jumbo v1, "call -> setTag failed, parameter [sn] is null"
    ...
    const-string/jumbo v1, "call -> setTag failed, parameter [tags] len > 200 is exceeds"
    ...
    const-string/jumbo v1, "call - > setTag failed, it be called too frequently"
...
.method public unBindAlias(Landroid/content/Context;Ljava/lang/String;ZLjava/lang/String;)Z
    ...
    const-string/jumbo v1, "call - > unBindAlias failed, it be called too frequently"
