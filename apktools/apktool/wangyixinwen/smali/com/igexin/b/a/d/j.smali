...
.method public final run()V
    ...
    const-string/jumbo v5, "|isBlock = false|cycyle = true|doTime = 0, "
    ...
    invoke-virtual {v2}, Lcom/igexin/b/a/d/e;->t()V

    invoke-virtual {v2}, Lcom/igexin/b/a/d/e;->v()V
    :try_end_1
    ...
    invoke-virtual {v0}, Lcom/igexin/b/a/d/f;->g()V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "TaskService|SERVICE_PROCESSING|finally|hasError = "

    invoke-virtual {v0, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v5, v2, Lcom/igexin/b/a/d/e;->t:Z
    ...
    invoke-virtual {v2}, Lcom/igexin/b/a/d/e;->s()Z
    ...
    const-string/jumbo v5, "|isPending = "

    invoke-virtual {v0, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v5, v2, Lcom/igexin/b/a/d/e;->p:Z
    ...
    iput v10, v2, Lcom/igexin/b/a/d/e;->A:I
    ...
    iput-object v0, v2, Lcom/igexin/b/a/d/e;->B:Ljava/lang/Exception;

    invoke-virtual {v2}, Lcom/igexin/b/a/d/e;->w()V
    ...
    invoke-virtual {v1}, Lcom/igexin/b/a/d/f;->g()V

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "TaskService|SERVICE_PROCESSING|finally|hasError = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, v2, Lcom/igexin/b/a/d/e;->t:Z
    ...
    const-string/jumbo v3, "|isPending = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, v2, Lcom/igexin/b/a/d/e;->p:Z

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v3, "|isCycle = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, v2, Lcom/igexin/b/a/d/e;->o:Z

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v3, "|isBlcok = "
