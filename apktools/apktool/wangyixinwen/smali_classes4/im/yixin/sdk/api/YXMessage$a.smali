.class public Lim/yixin/sdk/api/YXMessage$a;
...
.method public static a(Lim/yixin/sdk/api/YXMessage;)Landroid/os/Bundle;
    ...
    const-string/jumbo v1, "_yixinmessage_version"
    ...
    const-string/jumbo v1, "_yixinmessage_title"

    iget-object v2, p0, Lim/yixin/sdk/api/YXMessage;->title:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "_yixinmessage_description"

    iget-object v2, p0, Lim/yixin/sdk/api/YXMessage;->description:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "_yixinmessage_thumbdata"

    iget-object v2, p0, Lim/yixin/sdk/api/YXMessage;->thumbData:[B

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putByteArray(Ljava/lang/String;[B)V

    iget-object v1, p0, Lim/yixin/sdk/api/YXMessage;->messageData:Lim/yixin/sdk/api/YXMessage$b;

    if-eqz v1, :cond_0

    const-string/jumbo v1, "_yixinmessage_dataClass"

    iget-object v2, p0, Lim/yixin/sdk/api/YXMessage;->messageData:Lim/yixin/sdk/api/YXMessage$b;
    ...
    invoke-interface {v1, v0}, Lim/yixin/sdk/api/YXMessage$b;->write(Landroid/os/Bundle;)V
...
.method public static a(Landroid/os/Bundle;)Lim/yixin/sdk/api/YXMessage;
    ...
    const-string/jumbo v0, "_yixinmessage_version"
    ...
    const-string/jumbo v0, "_yixinmessage_title"
    ...
    const-string/jumbo v0, "_yixinmessage_description"
    ...
    const-string/jumbo v0, "_yixinmessage_thumbdata"
    ...
    const-string/jumbo v0, "_yixinmessage_dataClass"
    ...
    const-string/jumbo v2, " data class is blank"
    ...
    check-cast v0, Lim/yixin/sdk/api/YXMessage$b;

    iput-object v0, v1, Lim/yixin/sdk/api/YXMessage;->messageData:Lim/yixin/sdk/api/YXMessage$b;

    iget-object v0, v1, Lim/yixin/sdk/api/YXMessage;->messageData:Lim/yixin/sdk/api/YXMessage$b;

    invoke-interface {v0, p0}, Lim/yixin/sdk/api/YXMessage$b;->read(Landroid/os/Bundle;)V
    :try_end_0
    ...
    const-string/jumbo v5, " data class is not found  "
