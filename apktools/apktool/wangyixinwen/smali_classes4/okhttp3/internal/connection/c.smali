...
.method private a(IILokhttp3/z;Lokhttp3/s;)Lokhttp3/z;
    ...
    invoke-direct {v4, v2, v2, v0, v1}, Lokhttp3/internal/c/a;-><init>(Lokhttp3/x;Lokhttp3/internal/connection/f;Lokio/e;Lokio/d;)V

    .line 318
    iget-object v0, p0, Lokhttp3/internal/connection/c;->n:Lokio/e;

    invoke-interface {v0}, Lokio/e;->timeout()Lokio/t;
    ...
    invoke-virtual {v0, v6, v7, v1}, Lokio/t;->a(JLjava/util/concurrent/TimeUnit;)Lokio/t;

    .line 319
    iget-object v0, p0, Lokhttp3/internal/connection/c;->o:Lokio/d;

    invoke-interface {v0}, Lokio/d;->timeout()Lokio/t;
    ...
    invoke-virtual {v4, v0}, Lokhttp3/internal/c/a;->a(Z)Lokhttp3/ab$a;
    ...
    .line 331
    :cond_1
    invoke-virtual {v4, v0, v1}, Lokhttp3/internal/c/a;->b(J)Lokio/s;
    ...
    invoke-static {v0, v1, v4}, Lokhttp3/internal/c;->b(Lokio/s;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-virtual {v5, v1}, Lokhttp3/ab;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(II)V
    ...
    invoke-static {v0}, Lokio/l;->b(Ljava/net/Socket;)Lokio/s;
    ...
    invoke-static {v0}, Lokio/l;->a(Ljava/net/Socket;)Lokio/r;
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/c;->h:Lokhttp3/ad;
...
.method private b(Lokhttp3/internal/connection/b;)V
    ...
    invoke-static {v2}, Lokio/l;->b(Ljava/net/Socket;)Lokio/s;

    move-result-object v2

    invoke-static {v2}, Lokio/l;->a(Lokio/s;)Lokio/e;
    ...
    invoke-static {v2}, Lokio/l;->a(Ljava/net/Socket;)Lokio/r;
...
.method public a(Lokhttp3/x;Lokhttp3/internal/connection/f;)Lokhttp3/internal/b/c;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {v0, p1, p2, v1}, Lokhttp3/internal/http2/d;-><init>(Lokhttp3/x;Lokhttp3/internal/connection/f;Lokhttp3/internal/http2/e;)V
    ...
    invoke-direct {v0, p1, p2, v1, v2}, Lokhttp3/internal/c/a;-><init>(Lokhttp3/x;Lokhttp3/internal/connection/f;Lokio/e;Lokio/d;)V
...
.method public a(Lokhttp3/internal/http2/g;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/http2/g;->close(Lokhttp3/internal/http2/ErrorCode;)V

    .line 451
    return-void
.end method

.method public a(Lokhttp3/a;)Z
    .locals 2
    ...
    invoke-virtual {p1, v0}, Lokhttp3/a;->equals(Ljava/lang/Object;)Z
