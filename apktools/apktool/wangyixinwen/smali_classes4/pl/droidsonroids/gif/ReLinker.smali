...
.method private static unpackLibrary(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {v4, p1}, Lpl/droidsonroids/gif/ReLinker$1;-><init>(Ljava/lang/String;)V

    .line 89
    invoke-static {v0, v4}, Lpl/droidsonroids/gif/ReLinker;->clearOldLibraryFiles(Ljava/io/File;Ljava/io/FilenameFilter;)V
    ...
    .line 96
    :try_start_0
    invoke-static {v5}, Lpl/droidsonroids/gif/ReLinker;->openZipFile(Ljava/io/File;)Ljava/util/zip/ZipFile;
    :try_end_0
    ...
    .line 100
    :try_start_1
    invoke-static {p1, v5}, Lpl/droidsonroids/gif/ReLinker;->findLibraryEntry(Ljava/lang/String;Ljava/util/zip/ZipFile;)Ljava/util/zip/ZipEntry;
    ...
    .line 110
    :try_start_5
    invoke-static {v4, v2}, Lpl/droidsonroids/gif/ReLinker;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_5
    ...
    .line 117
    :try_start_6
    invoke-static {v4}, Lpl/droidsonroids/gif/ReLinker;->closeSilently(Ljava/io/Closeable;)V

    .line 118
    invoke-static {v2}, Lpl/droidsonroids/gif/ReLinker;->closeSilently(Ljava/io/Closeable;)V

    .line 120
    invoke-static {v0}, Lpl/droidsonroids/gif/ReLinker;->setFilePermissions(Ljava/io/File;)V
    :try_end_6
