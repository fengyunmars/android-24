...
.method public constructor <init>(Lrx/j;)V
    ...
    new-instance v0, Lrx/internal/util/a/x;

    invoke-direct {v0}, Lrx/internal/util/a/x;-><init>()V

    :goto_0
    invoke-direct {p0, p1, v0}, Lrx/internal/producers/QueuedProducer;-><init>(Lrx/j;Ljava/util/Queue;)V
...
.method public constructor <init>(Lrx/j;Ljava/util/Queue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 62
    iput-object p1, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/j;
...
.method private checkTerminated(ZZ)Z
    ...
    .line 120
    iget-object v1, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/j;
    ...
    .line 127
    iget-object v2, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/j;

    invoke-virtual {v2, v1}, Lrx/j;->onError(Ljava/lang/Throwable;)V
...
.method private drain()V
    ...
    .line 140
    iget-object v6, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/j;
    ...
    invoke-virtual {v6, v0}, Lrx/j;->onNext(Ljava/lang/Object;)V
    ...
    .line 169
    :cond_7
    invoke-virtual {v6, v1}, Lrx/j;->onNext(Ljava/lang/Object;)V
    :try_end_0
    ...
    :goto_4
    invoke-static {v2, v6, v0}, Lrx/exceptions/a;->a(Ljava/lang/Throwable;Lrx/e;Ljava/lang/Object;)V
