 ...
 * addition of manipulators 操纵器 so that the list can be modified or
 * reused.</p>
 * <p>
 * <p>There are two typical uses of this class:</p>
 * <p>
 * <ol>
 * <li>to take a persistent snapshot  快照 of an Attributes object
...
public class AttributesImpl implements Attributes {
     ...
     * rather than constantly 不断地 allocating new ones.</p>
     *
    ...
    /**
     * Report a bad array index in a manipulator. 操纵器
     *
