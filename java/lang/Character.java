 ...
 * Consortium 共同体 . This file specifies various properties including name
 ...
 * </ul>
 * <p>
 * <h4><a name="unicode">Unicode Character Representations 表现 </a></h4>
 * <p>
 * <p>The {@code char} data type (and therefore the value that a
 * {@code Character} object encapsulates) are based on the
 * original Unicode specification 规格 , which defined characters as
 * fixed-width 固定的 16-bit entities. The Unicode Standard has since been
 * changed to allow for characters whose representation requires more
 * than 16 bits.  The range of legal <em>code point</em>s is now
 * U+0000 to U+10FFFF, known as <em>Unicode scalar 标量的 value</em>.
 * (Refer to the <a
 * href="http://www.unicode.org/reports/tr27/#notation"><i>
 * definition</i></a> of the U+<i>n</i> notation 标记法 in the Unicode
 * Standard.)
 * <p>
 * <p><a name="BMP">The set of characters from U+0000 to U+FFFF is
 * sometimes referred to as the <em>Basic Multilingual 使用多种语言的 Plane 平面 (BMP)</em>.
 * <a name="supplementary">Characters</a> whose code points are greater
 * than U+FFFF are called <em>supplementary 追加的 character</em>s.  The Java
 * platform uses the UTF-16 representation in {@code char} arrays and
 * in the {@code String} and {@code StringBuffer} classes. In
 * this representation, supplementary characters are represented as a pair
 * of {@code char} values, the first from the <em>high-surrogates 代理 </em>
 ...
 * including supplementary code points. The lower (least significant 重要的 )
 ...
 * (a CJK 中日韩统一表意文字 ideograph 象形（表意）文字 ).
 * </ul>
 * <p>
 ...
 * encoding. For more information on Unicode terminology 术语 , refer to the
 * <a href="http://www.unicode.org/glossary/">Unicode Glossary 词汇表 </a>.
 *
 * @author Lee Boynton
 * @author Guy Steele
 * @author Akira Tanaka
...
public final class Character implements java.io.Serializable, Comparable<Character> {
    /**
     * The minimum radix 根，基数 available for conversion 转变 to and from strings.
     * The constant value of this field is the smallest value permitted 允许
    ...
    */
    ...
    /**
     * General category "Nd" in the Unicode specification. DECIMAL decimal 十进位的
     *
     * @since 1.1
     */
    ...
    /**
     * General category "Cs" in the Unicode specification. SURROGATE surrogate 代理
     *
     * @since 1.1
     */
    ...
    /**
     * General category "Pd" in the Unicode specification.DASH dash 破折号 PUNCTUATION punctuation 标点符号
     *
     * @since 1.1
     */
    ...
    /**
     * General category "Sc" in the Unicode specification. CURRENCY currency 货币
     *
     * @since 1.1
     */
    ...
    /**
     * General category "Pf" in the Unicode specification. QUOTE quote引用
     *
     * @since 1.4
     */
    ...
    /**
     * Error flag. Use int (code point) to avoid confusion 混淆 with U+FFFF.
     */
    static final int ERROR = 0xFFFFFFFF;


    /**
     * Undefined bidirectional 双向的 character type. Undefined {@code char}
     * values have undefined directionality 方向性 in the Unicode specification.
     *
     * @since 1.4
     */
    ...
    /**
     * Strong bidirectional character type "AL" in the Unicode specification. ARABIC Arabic阿拉伯语
     *
     * @since 1.4
     */
    ...
    /**
     * Weak bidirectional character type "EN" in the Unicode specification. EUROPEAN European 欧洲的
     *
     * @since 1.4
     */
    ...
    /**
     * Neutral bidirectional character type "S" in the Unicode specification. SEGMENT segment 部分
     *
     * @since 1.4
     */
     ...
     * Unicode supplementary 追加的 code point</a>, constant {@code U+10000}.
     *
     * @since 1.5
     */
     ...
     * Other portions 一部分 of the Java API may define other subsets for their
     * own purposes.
     *
     * @since 1.2
     */
    ...
    public static final class UnicodeBlock extends Subset {
        ...
        /**
         * Constant for the "Latin-1 Supplement 补充 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "IPA Extensions" Unicode character block. IPA International Phonetic Alphabet 字母表
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Combining Diacritical 可区别的 Marks" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Greek 希腊语 and Coptic 科普特语 " Unicode character block.
         * <p>
        ...
        /**
         * Constant for the "Cyrillic 古代斯拉夫语字母的 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Armenian 亚美尼亚语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Hebrew 犹太人 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Arabic 阿拉伯语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Bengali 孟加拉语的 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Gurmukhi 果鲁穆奇语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Gujarati 古吉拉特语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Oriya 奥里雅语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Tamil 泰米尔语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Telugu 泰卢固人 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Kannada 坎那达语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Malayalam 拉雅拉姆语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Thai 泰国语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Lao 老挝语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Tibetan 西藏的 藏族的" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Georgian 乔治亚的 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Hangul Jamo 朝鲜文 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "General Punctuation 标点 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Superscripts 标在上方的 and Subscripts 下标 " Unicode character
         * block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Combining Diacritical 可区别的 Marks for Symbols" Unicode
         * character block.
         * <p>
        ...
        /**
         * Constant for the "Letterlike Symbols 字母式符号 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Arrows 箭头 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Miscellaneous 混杂的 Technical 专门的 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Optical 光学的 Character Recognition 识别 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Enclosed 被附上的 Alphanumerics 字母数字的 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Geometric 几何学的 Shapes" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Miscellaneous 混杂的 Symbols" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Dingbats 装饰标志 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "CJK Symbols and Punctuation 标点符号 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Hiragana 平假名 日语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Katakana 片假名 日语 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Hangul 韩语 Compatibility Jamo" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Kanbun 宽文 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "CJK Unified 统一的 Ideographs 象形文字 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Hangul Syllables  音节 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "CJK Compatibility Ideographs 表意 " Unicode character
         * block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Alphabetic 字母(表)的 Presentation Forms" Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Small Form Variants 变体 " Unicode character block.
         *
         * @since 1.2
         */
        ...
        /**
         * Constant for the "Syriac 叙利亚语的 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Thaana 马尔代夫语 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Sinhala 僧伽罗语 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Myanmar  缅甸 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Ethiopic 埃塞俄比亚语 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Cherokee 彻罗基族人 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Unified 统一的 Canadian 加拿大人 Aboriginal 土著居民 Syllabics 音节的 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Ogham 欧甘文 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Runic 古代北欧文字的 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Khmer 高棉语 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Mongolian 蒙古语 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Braille 盲人用点字法 Patterns" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "CJK Radicals 自由基 Supplement 补充 " Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Kangxi 康熙 Radicals" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Ideographic 表意的 Description Characters" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Bopomofo 汉语拼音字母 Extended" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "CJK Unified Ideographs 表意 Extension A" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Yi Syllables 音节" Unicode character block.
         *
         * @since 1.4
         */
        ...
        /**
         * Constant for the "Cyrillic 古代斯拉夫语字母的 Supplementary 补充的 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Tagalog 塔加拉族语 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Hanunoo 哈努诺文 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Buhid 保加利亚文 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Tagbanwa 塔格巴努亚文 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Limbu 林布族 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Tai Le 德宏傣文 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Khmer 高棉人 Symbols" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Katakana 片假名 Phonetic Extensions" Unicode character
         * block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Yijing 易经 Hexagram 六角星形 Symbols" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Linear B Syllabary 音节表 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Aegean 爱琴海的 Numbers" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Old Italic 古意大利 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Gothic 哥特式的 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Ugaritic  乌加里特语的 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Deseret  德撒律 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Shavian 萧伯纳崇拜者 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Osmanya 奥斯曼亚字母 " Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Cypriot 塞浦路斯人 Syllabary" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Byzantine 拜占庭人 Musical Symbols" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Tai Xuan Jing 太玄经 Symbols" Unicode character block.
         *
         * @since 1.5
         */
        ...
        /**
         * Constant for the "Samaritan 撒马利亚人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Mandaic 曼达语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ethiopic 埃塞俄比亚语 Supplement" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Unified Canadian Aboriginal 土著居民 Syllabics Extended"
        ...
        /**
         * Constant for the "New Tai Lue 新傣仂语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Buginese 布吉语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Tai Tham 老傣仂文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Balinese 巴厘人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Sundanese 巽他人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Batak 巴塔克人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Lepcha 雷布查人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ol Chiki 桑塔利文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Vedic 吠陀梵语 Extensions" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Glagolitic 格拉哥里语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Coptic 科普特语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Georgian 乔治亚州人 Supplement" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Tifinagh 提非纳文字 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ethiopic 埃塞俄比亚语 Extended" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Cyrillic 古代斯拉夫语字母的 Extended-A" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "CJK Strokes 笔画 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Lisu 傈僳族 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Cyrillic 古代斯拉夫语字母的 Extended-B" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Bamum 巴姆穆语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Modifier 语气；色调；音调；音色 Tone Letters" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Syloti Nagri 锡尔赫特文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Common Indic 印度的 Number Forms" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Phags-pa 八思巴文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Saurashtra 索拉什特拉 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Devanagari 梵文字母 Extended" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Kayah Li 克耶字母 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Rejang 拉让江 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Hangul 韩语 Jamo Extended-A" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Javanese 爪哇语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Cham 可汗 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Myanmar  缅甸 Extended-A" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Tai Viet 越南傣文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ethiopic 埃塞俄比亚语 Extended-A" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Meetei Mayek 曼尼普尔文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ancient 古代人 Greek 希腊语 Numbers" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ancient 古代人 Symbols" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Phaistos 斐斯托斯 Disc 唱片 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Lycian 利西亚人的 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Carian 卡里安 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Old Persian 古波斯语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Imperial 帝国的 Aramaic 阿拉姆语" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Phoenician  腓尼基人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Lydian 里底亚语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Kharoshthi 佉卢文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Old South Arabian 古南阿拉伯文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Avestan 阿维斯陀语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Inscriptional 碑文 Parthian 帕提亚人 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Inscriptional Pahlavi 巴拉维语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Old Turkic 突厥语 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Rumi 德、西、意、匈、阿拉伯 Numeral Symbols" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Brahmi 婆罗米文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Kaithi 凯提文 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Cuneiform 楔形文字 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Egyptian 埃及人 Hieroglyphs 象形文字 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Bamum 巴姆穆语 Supplement" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Ancient Greek  希腊语 Musical Notation  符号 " Unicode character
         * block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Counting Rod (英、法、德、捷、希) Numerals" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Mahjong 麻将 Tiles 瓷砖 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Domino 多米诺骨牌 Tiles" Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Emoticons 情感符 " Unicode character block.
         *
         * @since 1.7
         */
        ...
        /**
         * Constant for the "Alchemical 炼金术的 Symbols" Unicode character block.
         *
         * @since 1.7
         */
        ...
        public static UnicodeBlock of(int codePoint) {
            ...
            // invariant 不变量 : top > current >= bottom && codePoint >= unicodeBlockStarts[bottom]
            while (top - bottom > 1) {
         ...
         * <ol>
         * <li> Canonical 权威的 block names as defined by the Unicode Standard.
         ...
         * hyphens 连字符 in the canonical name with underscores 划线于…下 .
         * </ol>
     ...
     * <i>Unicode Standard Annex 附加 #24: Script Names</i></a>. Every Unicode
     ...
     * {@link #Character(char)}, as this method is likely to yield 获利
     ...
     * length 1 whose sole 惟一的 component is the primitive
     ...
     * {@link #MAX_CODE_POINT} inclusive 包括的 ;
     * {@code false} otherwise.
     * @since 1.5
     */
    ...
    public static boolean isBmpCodePoint(int codePoint) {
        ...
        // We consistently 坚持地 use logical shift (>>>) to facilitate
    ...
    /**
     * Returns the code point preceding 前面的 the given index of the
     * {@code CharSequence}. If the {@code char} value at
     ...
     * {@code LOWERCASE_LETTER}, or it has contributory 促成的 property
    ...
    /**
     * Determines if the specified character is permissible 可允许的 as the first
    ...
    /**
     * Determines if the specified character (Unicode code point) is an alphabet 字母表 .
     * <p>
     ...
     * </ul>
     * or it has contributory 起作用的 property Other_Alphabetic as defined by the
     * Unicode Standard.
     *
     * @param codePoint the character (Unicode code point) to be tested.
     ...
     * (Chinese, Japanese, Korean and Vietnamese 越南人 ) ideograph 象形（表意）文字 , as defined by
    ...
    public static int getType(int codePoint) {
        ...
        // The type values returned by ICU (International Components for Unicode) are not RI-compatible. The RI skips the value 17.
     ...
     * glyphs 符号  horizontally mirrored when displayed in text that is
     * right-to-left.  For example, {@code '\u005Cu0028'} LEFT
     * PARENTHESIS 圆括号 is semantically defined to be an <i>opening
