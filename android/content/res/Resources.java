...
public class Resources {
     ...
     * some <b>other type</b> of <b>CharSequence</b> if it is styled.
     * {@more}
     *
    ...
    /**
     * Returns the character sequence necessary for grammatically 符合语法规则地 correct pluralization 多元化
     * of the given resource ID for the given quantity 数量 .
     * Note that the character sequence is selected based solely 仅仅; 纯粹; 唯一地; 独一无二地 on grammatical 语法上的 necessity  需要 ,
     ...
     * substituting 替换 the format arguments as defined in {@link java.util.Formatter}
    ...
    /**
     * Return an array of heterogeneous 成分混杂的 values.
     *
     * @param id The desired resource identifier, as generated by the aapt
     *           tool. This integer encodes the package, type, and resource
     *           entry. The value 0 is an invalid identifier.
    ...
    static class ThemeKey implements Cloneable {
        ...
        /**
         * @return a shallow 浅的 copy of this key
         */
        @Override
