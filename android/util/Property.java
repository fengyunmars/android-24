...
/**
 * A property is an abstraction that can be used to represent a <emb>mutable 易变的 </em> value that is held
...
public abstract class Property<T, V> {
    ...
    /**
     * A constructor that takes an identifying 确认 name and {@link #getType() type} for the property.
     */
