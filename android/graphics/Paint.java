...
public class Paint {
   ...
   /**
    ...
    /**
     * Helper for setFlags(), setting or clearing the ANTI_ALIAS_FLAG 抗锯齿  bit
     * AntiAliasing smooths out 消除  the edges of what is being drawn, but is has
     * no impact on the interior 内部的  of the shape. See setDither() and
     * setFilterBitmap() to affect how colors are treated.
     *
