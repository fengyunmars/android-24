...
public interface Cursor extends Closeable {
     ...
     * These should be consistent 一致  with the corresponding types defined in CursorWindow.h
     */
     ...
     * set then the resultant 结果 position will be pinned to -1 or count() depending
     ...
     * If the buffer size is not sufficient 足够的 , a new char buffer will be allocated 
    ...
    /**
     * Deactivates 使无效  the Cursor, making all calls on it fail until {@link #requery} is called.
